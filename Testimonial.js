  ...
  return (
    <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center
     items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl'>
       ...
       <div className='flex text-3xl mt-5 gap-3 text-violet-400 font-bold place-items-center '>
          <button 
       ...
       <div className='mt-6'>
          ...
          className='bg-violet-400 hover:bg-violet-500 transiton-all duration-200
